...
export default function Hero({
  ...
  description = 'Acme Tech delivers enterprise-grade solutions that streamline operations, boost productivity, and accelerate growth for modern businesses.',
  features = [
